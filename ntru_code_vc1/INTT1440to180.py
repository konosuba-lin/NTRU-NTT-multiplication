...
def INTT1440to180():
    ...
    for j in range(180):
        ...
        '''f.write("      vmov.w r9, s1\n")
        f.write("      smull.w r"+str(5)+", r"+str(2)+", r"+str(2)+", r"+str(7)+"\n")
        f.write("      smlal.w r"+str(5)+", r"+str(2)+", r"+str(4)+", r"+str(9)+"\n")
        montgomery_reduction(5,2)'''
        ...
        f.write("      subs.w r"+str(1)+", r"+str(1)+", #"+str(720*sd_w)+" \n") #let r1 back to 0
